...
//Yii::import('application.vendor.softLayer.ObjectStorage.Util', true); // Require Zend autoloader
//spl_autoload_register(array('__autoload_objectStorage_client', 'autoload')); // Register Zend autoloader
