...
<section class="brief timeline white-bg" id="section8">
	<div class="container">
					...
					<h2 class="dark-text">Compare With Others</h2>
					<div class="colored-line"></div>

		<table style="margin-top:40px;" class="compareUs col col-xs-12">
			<thead>
			<tr>
				<th class="col col-xs-3 col-sm-4 hidden-xs"></th>
				<th class="col col-xs-3 col-sm-3"><b>SCRYPTmail</b></th>
				<th class="col col-xs-3 col-sm-3"><b>Tutanota</b></th>
				<th class="col col-xs-3 col-sm-2"><b>Protonmail</b></th>
			</tr>
			</thead>
			...
			<tr onclick="$('.hiddens').toggle()">
				<td  class="hiddens" style="display:table-cell; border:0px solid;" colspan="4"><a href="javascript:void(0);">More</a></td>
				<td  class="hiddens" style="border:0px solid;" colspan="4"><a href="javascript:void(0);">Less</a></td>
			</tr>
...
<section class="services grey-bg" id="why">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-heart"></span>
					</div>
					<h3 class="colored-text">Genuine</h3>
			...
			<div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-case"></span>
					</div>
					<h3 class="colored-text">Private</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInRight" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-man-people-streamline-user"></span>
					</div>
					<h3 class="colored-text">Anonymous</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-close-alt2"></span>
					</div>
					<h3 class="colored-text">No Third Party Server Scripts</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInRight" data-wow-offset="10" data-wow-duration="1s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-elaboration-todolist-check"></span>
					</div>
					<h3 class="colored-text">PGP & NIST Recommendations</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInRight" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-world"></span>
					</div>
					<h3 class="colored-text">Grade A HTTPS Encryption</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class=" iconsplash-basic-lock"></span>
					</div>
					<h3 class="colored-text">Encrypted</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-elaboration-browser-plus"></span>
					</div>
					<h3 class="colored-text">Freedom and Simplicity</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
			...
			<div class="col-md-4 wow fadeInRight" data-wow-offset="10" data-wow-duration="1.75s">
				<div class="single-service marginBottom50 border-bottom-hover hasSMailOverlay">
					<div class="service-icon colored-text">
						<span class="iconsplash-basic-paperplane"></span>
					</div>
					<h3 class="colored-text">Send Anywhere</h3>
					<div class='sMailOverlay' style="overflow:hidden;">
						<p class='textMiddle'>
...
<section class="brief timeline white-bg" id="section8">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 timeline-text text-left wow fadeInLeft" data-wow-offset="20" data-wow-duration="1s">
				<div class="small-text-medium uppercase colored-text text-left">
					Progress
				</div>
				<h2 class="text-left dark-text"><strong>Continuous</strong> Improvement</h2>
				...
				<ul class="vertical-timeline" id="timeline-scroll">
					...
					<li class='first'>
						...
						<div class="iconsplash-container color-bg white-text">
							<span class="iconsplash-lightbulb-alt"></span>
						</div>
						<div class="info">
					...
					<li>
						...
						<div class="iconsplash-container color-bg white-text">
							<span class="iconsplash-software-pencil"></span>
						</div>
						<div class="info">
...
<!-- =========================
 SECTION: TEAM
 ============================== -->
<section class="team grey-bg" id="aboutUs">
	<div class="container">

		<!-- SECTION HEADER -->
		<div class="section-header">
			<h2 class="dark-text"><strong>SCRYPTmail</strong> Team</h2>
			<div class="colored-line">
			</div>
			<div class="sub-heading">
				We are passionate about creating secure and usable email.
			</div>
		</div>
				...
				<div class='row'>
					<div class="col-md-8 col-md-offset-2">
						<div class="team-member wow fadeInUp " data-wow-offset="10" data-wow-duration="1s">
							<div class="member-pic hasSMailOverlay">
								<img src="/img/team/tori.jpg" alt="">
								<div class='sMailOverlay sMailTextAlignLeft' style="overflow-x:hidden;">
									<p>
							...
							<div class="member-details">
								<h5 class="colored-text">Victoria Wilson </h5>
			...
			<div class='col-sm-4 col-md-offset-4'>
				<div class='row'>
					<div class="col-md-8 col-md-offset-2">
						<div class="team-member wow fadeInUp" data-wow-offset="10" data-wow-duration="1s">
							<div class="member-pic hasSMailOverlay">
								<img src="/img/team/sergei.jpg" alt="">
								<div class='sMailOverlay sMailTextAlignLeft' style="overflow-x:hidden;" id="serg">
									<p>
							...
							<div class="member-details">
								<h5 class="colored-text">Sergei Krutov</h5>
								<div class="small-text">
									Founder
								</div>
								<div class="small-text">
				...
				<div class='row'>
					<div class="col-md-8 col-md-offset-2">
						<div class="team-member wow fadeInUp" data-wow-offset="10" data-wow-duration="1s">
							...
							<div class="member-details">
								<h5 class="colored-text">Aaron Colby</h5>
								<div class="small-text">
									Developer
								</div>
								<div class="small-text">
