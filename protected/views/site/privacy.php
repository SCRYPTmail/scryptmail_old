	...
	<div id="content" class="container">
		...
		<div class="row">
			...
			<h1 class="txt-color-red login-header-big">Privacy Policy</h1>
				...
				<div class='innerText'>We collect information from you when you register on our site, subscribe to a newsletter or
				...
				<div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To send periodic emails regarding your
				...
				<div class='innerText'>We implement a variety of security measures enters, submits, or accesses their information to
				...
				<div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Manage your session tokens.
				</div>
				...
				<div class='innerText'>
					<div class='innerText'>Ability to login into am account</div>
				...
				<div class='innerText'>We do not sell, trade, or otherwise transfer to outside parties your personally identifiable
					...
					property, or safety. <br><br> However, non-personally identifiable visitor information may be provided to other
				...
				<div class='innerText'>Occasionally, at our discretion, we may include or offer third party products or services on
				...
				<div class='innerText'>Our Privacy Policy link includes the word 'Privacy', and can be easily be found on the page
					specified above.
				</div>
				...
				<div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By logging in to their account</div>
				...
				<div class='innerText'><br><strong>To be accordance with CANSPAM we agree to the following:</strong></div>
